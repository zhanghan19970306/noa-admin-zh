  ...
  <div class="layout layout-wrap--horizontal">
    <div class="layout-aside">
      <div class="layout-aside-logo">
        <img class="layout-aside__logo" src="~/assets/images/logo--dark.svg" alt="logo" />
      </div>
      ...
      <el-tooltip
        ...
        placement="right"
      >
        <div class="layout-aside-item" @click="onMenuClick('one', item)">
...
export default {
  ...
  methods: {
    iconObjClass(item) {
      return ['layout-aside-item__icon', item.icon ? item.icon : 'el-icon-menu']
    },
        ...
        if (level === 'one') {
          ...
          if (menuInfo.url) {
            ...
            if (currentFirstSub.url) {
              ...
              this.$set(this, `threeMenus`, currentFirstSub.children)
              this.$store.dispatch('setMenuActive', {
                level: 'three',
